...
public class Poker {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 2; i++) {
            for (int j = 0; j < 3; j++) {
              System.out.print(String.format( "%.2f", flash_preflop[i][j])+ "\t");// округление через  java.util.Formatter, разделитель целой и десятичной частей зависит от java.util.Locale:
